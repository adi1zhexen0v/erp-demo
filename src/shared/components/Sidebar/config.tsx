    ...
    items: [
      {
        ...
        children: [
          ...
          { type: "link", label: "accounting.purchases", href: ACCOUNTING_PURCHASES_PAGE_ROUTE },
          { type: "link", label: "accounting.warehouse", href: ACCOUNTING_WAREHOUSE_PAGE_ROUTE },
          { type: "link", label: "accounting.rentals", href: ACCOUNTING_RENTALS_PAGE_ROUTE },
          { type: "link", label: "accounting.reports", href: ACCOUNTING_REPORTS_PAGE_ROUTE },
          { type: "link", label: "accounting.tax", href: ACCOUNTING_TAX_ROUTE },
        ],
      },
      {
        type: "link",
