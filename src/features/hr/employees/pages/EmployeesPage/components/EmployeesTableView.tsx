...
import { formatDateForDisplay, formatMoneyKzt, type Locale } from "@/shared/utils";
        ...
        <Table.Table className="min-w-[1100px]">
          ...
          <Table.Body>
            {employees.map((emp, index) => {
              ...
              const iin = emp.iin || "—";
              const startDate = emp.active_contract?.start_date
                ? formatDateForDisplay(emp.active_contract.start_date)
                : "—";
              ...
              const salaryFormatted = salaryNum ? formatMoneyKzt(salaryNum, locale) : "—";
