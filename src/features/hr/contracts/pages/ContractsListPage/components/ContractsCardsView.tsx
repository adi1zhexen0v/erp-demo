...
import { RESIGNATION_STATUS_MAPPING } from "@/features/hr/resignation-letters/consts/statusMappings";
    ...
    <>
      ...
      {previewingContractId !== null && (
        <Prompt
          ...
          title=""
          text=""
          loaderText={t("messages.loader.downloadingDraft.text")}
          additionalText={t("messages.loader.downloadingDraft.additionalText")}
          namespace="ContractsPage"
        />
      )}
