...
import type { PayrollEntry, PayrollStatus, ConstantsUsed } from "@/features/accounting/payroll";
...
export default function PayrollEntryDetailModal({
  entry,
  constants_used,
  onClose,
  locale,
  ...
  function renderTabContent() {
    switch (activeTab) {
      case TAB_IDS.ACCRUAL:
        return <AccrualTab entry={entryData} constants_used={constants_used} isFullScreen={isFullScreen} />;
        ...
        <div className="flex flex-col h-full min-h-0">
          ...
          <div className="flex items-center gap-4 py-5 border-b surface-base-stroke">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-label-sm content-action-neutral">{entry.worker.iin}</p>
            </div>
          </div>
