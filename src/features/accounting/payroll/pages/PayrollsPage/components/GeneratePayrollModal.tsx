...
import type { GeneratePayrollDto, PayrollListResponse } from "@/features/accounting/payroll";
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          {approvedTimesheets.length === 0 ? (
            <p className="text-body-regular-sm content-action-neutral">{t("generate.noApprovedTimesheets")}</p>
          ) : (
            <Select
