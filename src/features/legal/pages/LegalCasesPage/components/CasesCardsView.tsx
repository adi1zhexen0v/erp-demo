  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 mt-7">
      <div className="flex flex-col gap-5 radius-lg border surface-base-stroke surface-base-fill p-5">
        <Badge variant="soft" color="info" text={t("cards.status.inProgress")} />
        ...
        <div className="flex flex-col gap-3">
          <div className="py-3 border-b border-t surface-base-stroke flex flex-col gap-1.5">
            <span className="text-body-bold-xs content-base-secondary">{t("cards.priority.label")}</span>
            <Badge
              variant="filled"
              color="notice"
              text={t("cards.priority.medium")}
              icon={<MaskLeft variant="Bold" size={12} color="currentColor" />}
            />
          </div>

          <div className="flex flex-col gap-1.5">
            <span className="text-body-bold-xs content-base-secondary">{t("cards.fields.startDate")}</span>
